...
int inner_entry(int argc, char **argv)
{
  ...
  string hFname = stringc << prefix0.c_str() << "_Parsers.h";
  string ccFname = stringc << prefix0.c_str() << "_Parsers.cc";
