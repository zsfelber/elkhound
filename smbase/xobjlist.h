...
public:
  ...
  public:
  className[[[]]](DBG_INFO_FORMAL_FIRST str::StoragePool &pool)                            : str::Storeable(DBG_INFO_ARG_FWD_FIRST  pool), list(DBG_INFO_ARG0_FIRST  *this,0) {}
  className[[[]]](DBG_INFO_FORMAL_FIRST str::Storeable const &parent)                      : str::Storeable(DBG_INFO_ARG_FWD_FIRST  parent, sizeof(className)), list(DBG_INFO_ARG0_FIRST  *this,0) {}
]]], [[[m4_dnl          // objlist
...
private:
  ...
  public:
  className[[[]]](DBG_INFO_FORMAL_FIRST str::StoragePool &pool)                            : str::Storeable(DBG_INFO_ARG_FWD_FIRST  pool), list(DBG_INFO_ARG0_FIRST  *this,0), owning(true) {}
  className[[[]]](DBG_INFO_FORMAL_FIRST str::Storeable const &parent)                      : str::Storeable(DBG_INFO_ARG_FWD_FIRST  parent, sizeof(className)), list(DBG_INFO_ARG0_FIRST  *this,0), owning(true) {}
]]])m4_dnl
